...
const data = [
    {id: 'Karolina', name: 'Каролина', title: 'Красивая девушка с выразительными скулами ☺', services: 'Классика\nАнал\nМинет\nМассаж\nБез презерватива / С презервативом', h: '2500', h2: '5000', night: '7500'},
    {id: 'Karina', name: 'Карина', title: 'Милая, очаровательная девочка ❤\nКоторая всегда готова пошалить 🤫', services: 'Стандартный секс с резинкой 🥰\nСекс без резинки (любые позы)\nГлубокий минет (куни по желанию)', h: '3000', h2: '6000', night: '9000'},
    {id: 'Vlada', name: 'Влада', title: 'Молодая, красивая, заботливая, без болезней', services: '', h: '2500', h2: '5000', night: '7500'},
    {id: 'Katya25', name: 'Катя', title: '💜Молодая\n🔥Красивая\nНЕ принимаю\nНЕ курю\n НЕ пью', services: 'мбр 2000₽\nМинет в машине 2000₽\nАнал 3200₽\nМассаж 3500₽', h: '3000', h2: '6000', night: '9000'},
    {id: 'Kristina', name: 'Кристина', title: 'Молодая, Красивая девушка', services: 'Класика, анал, минет', h: '2000', h2: '4000', night: '6000'},
    {id: 'Katya19', name: 'Катя', title: 'Наш вечер поможет забыть тебе о всех твоих не насущих проблемах🥰🔥💖💖💖', services: 'Эротический массаж, минет, анал и классика😉🔥\nПо желанию доминирование и БДСМ🔞💕', h: '3000', h2: '6000', night: '9000'},
    {id: 'Katya24', name: 'Катя', title: 'Классический безопасный секс, Минет без резинки', services: 'Небезопасный секс, Анал, БДСМ', h: '3000', h2: '6000', night: '9000'},
    {id: 'Margarita', name: 'Маргарита', title: 'Молодая, опытная.', services: 'Довожу до оргазма с кайфом, можем выпить)', h: '3000', h2: '6000', night: '9000'},
    {id: 'Olga', name: 'Ольга', title: 'Молодая, красивая, есть справки о том что я здорова.', services: 'Ты запомнишь это время на долго 🔥', h: '2500', h2: '5000', night: '7500'},
    {id: 'Anya', name: 'Аня', title: 'Молодая, красивая, спортивная 😜', services: 'Классический секс (с защитой)\nАнальный секс, доплата (с защитой/без)\nОральный секс/минет', h: '7000', h2: '14000', night: '21000'},
    {id: 'Eva', name: 'Евочка', title: 'Красивая и желанная', services: 'Люблю сосать', h: '3500', h2: '7000', night: '10500'},
    {id: 'Vika', name: 'Вика', title: 'Красотка, люблю брать в ротик, жду вас зайки😘', services: 'Люблю сосать😍, могу в любых позах😊', h: '2500', h2: '5000', night: '7500'},
    ...
    if (action === 'girls') {
        ...
        bot.sendMessage(msg.chat.id, '💚 *Анкеты наших девочек*\n' +
            ...
            '👋 Свободны сейчас: *15*',
            {
                ...
                reply_markup: {
                    inline_keyboard: [
                        [{text: 'Каролина 22 Года', callback_data: 'Karolina'}],
                        [{text: 'Карина 22 Года', callback_data: 'Karina'}],
                        [{text: 'Влада 22 Года', callback_data: 'Vlada'}],
                        [{text: 'Катя 25 Лет', callback_data: 'Katya25'}],
                        [{text: 'Кристина 18 Лет', callback_data: 'Kristina'}],
                        [{text: 'Катя 19 Лет', callback_data: 'Katya19'}],
                        [{text: 'Катя 24 Года', callback_data: 'Katya24'}],
                        [{text: 'Маргарита 22 Года', callback_data: 'Margarita'}],
                        [{text: 'Ольга 25 Лет', callback_data: 'Olga'}],
                        [{text: 'Аня 22 Года', callback_data: 'Anya'}],
                        [{text: 'Евочка 21 Год', callback_data: 'Eva'}],
                        [{text: 'Вика 21 Год', callback_data: 'Vika'}],
                        [{text: 'Юля 24 Года', callback_data: 'Yulia'}],
                        [{text: 'София 22 Года', callback_data: 'Sofa'}],
                        [{text: 'Анджелика 20 Лет', callback_data: 'Andgelika'}],
...
Внимательней проверяйте адрес Telegram, остерегайтесь мошенников, спасибо, что выбираете нас! 😎`, opts);
    ...
    if (action === 'Karolina' || action === 'Karina' || action === 'Vlada' ||
        action === 'Katya25' || action === 'Kristina' || action === 'Katya19' ||
        action === 'Katya24' || action === 'Margarita' || action === 'Olga' ||
        action === 'Anya' || action === 'Eva' || action === 'Vika' ||
        action === 'Yulia' || action === 'Sofa' || action === 'Andgelika') {
        person = action;
        bot.deleteMessage(msg.chat.id, msg.message_id)
